...
class IEMOCAPDataset(Dataset):
    ...
    def __init__(self, train=True):
        ...
        self.testVid = pickle.load(open('C:/fzh/10-emotion1/CMERC-master/IEMOCAP_features.pkl', 'rb'), encoding='latin1')

        _, _, self.roberta1, self.roberta2, self.roberta3, self.roberta4,\
        _, _, _, _ = pickle.load(open('C:/fzh/10-emotion1/CMERC-master/iemocap_features_roberta.pkl', 'rb'), encoding='latin1')
        '''
